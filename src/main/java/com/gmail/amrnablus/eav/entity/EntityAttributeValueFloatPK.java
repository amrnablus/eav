...
/**
 * The primary key class for the entity_attribute_value_float database table.
 * 
 */
@Embeddable
public class EntityAttributeValueFloatPK implements Serializable {
	...
	public EntityAttributeValueFloatPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof EntityAttributeValueFloatPK)) {
			return false;
		}
		EntityAttributeValueFloatPK castOther = (EntityAttributeValueFloatPK)other;
		return 
