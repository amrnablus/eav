...
/**
 * The primary key class for the entity_attribute_value_datetime database table.
 * 
 */
@Embeddable
public class EntityAttributeValueDatetimePK implements Serializable {
	...
	public EntityAttributeValueDatetimePK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof EntityAttributeValueDatetimePK)) {
			return false;
		}
		EntityAttributeValueDatetimePK castOther = (EntityAttributeValueDatetimePK)other;
		return 
